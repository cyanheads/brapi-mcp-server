---
summary: "Initial scaffold from @cyanheads/mcp-ts-core with complete MCP surface design — 19 tools and 9 resources for BrAPI v2.1 find/get, pedigree traversal, writes, filter discovery, and dataset lifecycle."
breaking: false
---
...
- Design doc at [`docs/design.md`](docs/design.md) covering:
  ...
  - 9 resources with paired tool paths so tool-only clients lose nothing.
